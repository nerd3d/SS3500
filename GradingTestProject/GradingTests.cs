    ...
    public class GradingTests
    {
        ...
        public void LongFormulaHelper(out object result)
        {
            try
            {
                ...
                Assert.AreEqual(Math.Pow(2, depth + 1), (double)s.GetCellValue("sum1"), 1.0); // my error is 1e17
                s.SetContentsOfCell("a" + i, "0");
                Assert.AreEqual(Math.Pow(2, depth), (double)s.GetCellValue("sum1"), 1.0); // my error is 1e16
